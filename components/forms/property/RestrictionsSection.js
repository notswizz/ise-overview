          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm hover:border-red-300 transition-colors">
            ...
            <div className="mt-4 bg-red-50 p-3 rounded-md border border-red-100">
              ...
              <p className="mt-1 text-xs text-red-700">
                Adding prohibited categories will prevent users from associating this property with the specified categories.
                Please ensure all stakeholders are aware of these restrictions.
              </p>
            </div>
          </div>
        </div>
